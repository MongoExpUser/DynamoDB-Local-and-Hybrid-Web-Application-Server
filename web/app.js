...
# *  This module deploys:                                                                                                               *
# *                                                                                                                                     *                                                                                                              *
# *     1)  A vanilla NodeJS HTTP or HTTPS server                                                                                       *
# *                                                                                                                                     *
# *  For Production Deployment:                                                                                                         *
# *                                                                                                                                     *
# *     1) Add relevant middlewares.                                                                                                    *
# *                                                                                                                                     *
# *     2) Add NodeJS Application route(s).                                                                                             *
# *                                                                                                                                     *                                                                                                                                  *
    ...
    constructor()
    {
        ...
        (function createServer()
        {
            ...
            else
            {
                ...
                server.listen(port, function listenOnServer() { console.log(`Server listening on http://${host}:${port}/ ...`) }).setMaxListeners(0);
            }
